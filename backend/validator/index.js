...
exports.createPatientAddtoBody = (req, res, next) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        let data = {};
        data.patient_full_name = fields.fullName;
        data.patient_gender = fields.gender;
        data.patient_dob = fields.dob;
        data.patient_address = fields.address;
        data.patient_pNumber = fields.pNumber;
        data.patient_email = fields.email;
        data.patient_hCard = fields.hCard;
        data.patient_information = fields.information;
        req.body = data;
        next();
    });
