...
import { create } from "./apiAccomplishments";
import { Redirect } from "react-router-dom";

class NewAccomplishment extends Component {
    constructor() {
        super();
        this.state = {
            title: "",
        ...
        <form>
         ...
         <h5 className="text-white">Completed</h5>
                ...
                />
                 ...
                 <div className="form-group">
         <h5 className="text-white">Accomplishment Type</h5>
        ...
        return (
            <section className="bg-secondary">
                <div className="container">
                    <br /><br /><br />
                <h2 className="mt-5 mb-5 text-white">Create a new accomplishment</h2>
                <div
...
export default NewAccomplishment;